...
export default function AuthPage() {
    const [formData, setFormData] = useState({
        name: "", // Giao diện vẫn dùng name, nhưng khi gửi API ta sẽ map sang username
        email: "",
        password: "",
        confirmpassword: ""
    });
    ...
    // Sử dụng login từ AuthContext để cập nhật state toàn cục
    ...
    const handleRegister = async () => {
        try {
            ...
            // Truyền formData.name vào biến username của hàm register
            await registerApi(
                formData.name, 
                formData.email,
                formData.password
            ...
            setLogin(true); // Chuyển form sang dạng Đăng nhập
            setFormData({...formData, password: "", confirmpassword: ""}); // Xóa pass cho an toàn
        } catch (error) {
            setServerError(error.message);
        } finally {
            setLoading(false);
